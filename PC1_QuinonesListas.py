...
while op != 4:
    ...
    if(op==1):
        ...
        if(len(votos)>0):
            ...
            print("+1.\tLuis Esperanza\t"+str(votos.count(1))+"\t+")
            print("+2.\tJose Barata\t\t"+str(votos.count(2))+"\t+")
            print("+3.\tMarco Ocras\t\t"+str(votos.count(3))+"\t+")
            print("+***********************+")
            print("+\tTOTAL VOTOS\t\t"+str(len(votos))+"\t+")
            print("+***********************+")
        else:
        ...
        total = []
        total.append(votos.count(1))
        total.append(votos.count(2))
        total.append(votos.count(3))
